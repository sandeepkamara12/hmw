                    ...
                    >
                      <span className="project-content-wrap flex flex-col items-start">
                        ...
                        <div className="flex flex-wrap space-y-2 items-end">
                          {Object.keys(project.status).length > 0 && (
                            <>
                              <div className="mr-2">
                                <Chip
                                  ...
                                  content={
                                    project.status
                                      .design_delivery_date_method === "quarter"
                                      ? project.status.design_delivery_date
                                      : moment(
                                          project.status.design_delivery_date
                                        ).format("ddd D")
                                  }
                              ...
                              <div className="mr-2">
                                <Chip
                                  overrideClasses="!mx-0"
                                  icon="progress"
                                  content={project.status?.stage}
                                  progressComplete={
                                    project.status?.progress_complete
                                  }
                                />
                              </div>
