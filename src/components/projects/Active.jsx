   ...
   return (
      <div className="px-4 sm:px-0">
         <div className='tab-panel'>
            <div className={`text-16 leading-20 mb-4 mt-8 font-semibold font-inter-regular text-black ${props.width <= 640 && 'mt-8'}`}>Q3 2022<span className='text-14 leading-18 font-normal ml-2 inline-block text-gray'>(Nov 1 - Jan 31)</span></div>
