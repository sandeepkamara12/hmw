...
const Button = (props) => {
   return (
      ...
      <button type={props.attributes.type} className={`${props.classes} ${props.attributes.loader ? 'bg-active border-active' : ''}`} disabled={props.attributes.disabled} onClick={props.attributes.clickEvent}>
         <svg width="20px" height="20px" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid" className={`${props.attributes.loader ? 'inline-block' : 'hidden'}`}>
            <g>
               ...
               <path d="M50 88 A38 38 0 0 1 12 50.00000000000001" fill="none" stroke="#ffffff" strokeWidth="3"></path>
               <path d="M12 50.00000000000001 A38 38 0 0 1 49.99999999999999 12" fill="none" stroke="#ffffff" strokeWidth="3"></path>
