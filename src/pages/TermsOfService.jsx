...
const TermsOfService = () => {
  useEffect(() => {
    document.title = `Terms of Service – HMW`;
  }, []);
  return (
    <div className="custom-container py-9">
      ...
      <div className="custom-medium-container">
        <div className="terms-content">
          ...
          <div className="last-updated mb-8 custom-input-field">
            Last Updated: September 30, 2022.
          </div>

          <h2 className="text-24 font-semibold font-inter-regular tracking-subHeading mb-8">
            Sub heading 1
          </h2>

          <h3 className="text-18 font-semibold font-inter-regular tracking-subHeading mb-4">
            Sub heading 2
          </h3>
          ...
          <ul className="list-disc list-inside">
            <li>
              <Link to="/" className="normalLink text-16 leading-20">
                November 15, 202
              </Link>
            </li>
            <li>
