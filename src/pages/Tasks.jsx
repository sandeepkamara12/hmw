...
const Tasks = () => {
   ...
   function openTaskModal() { setIsOpen(true) }
   function closeTaskModal() { setIsOpen(false) }
   const showSection = () => { setOpenSection(true) }
   ...
   return (
      <div className={`sm:ml-20 pt-7 pb-24 sm:py-18`}>
         ...
         <div className="custom-medium-container">
            <div className={hideButton === 'hide' ? 'border-b-fieldOutline' : 'relative px-4 sm:px-0'}>
               ...
               <div className='flex flex-wrap items-center justify-between'>
                  ...
                  <Chip overrideClasses="!mx-0 !hidden lg:!inline-flex" icon="status" content="On-track: Oct 12-14" />
               </div>
            </div>

            {
               activeTab.active ? <><PlanTasks width={width} />
                  <div className='add-section px-4 sm:px-0'>
                              ...
                              <div className="form-control flex flex-wrap items-center justify-between relative">
                                 ...
                                 <div className="sub-task-field-wrap">
                                    ...
                                    <div className='delete-section absolute right-4 cursor-pointer group top-4'>
                                       <svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={closeSection}>
                     ...
                     <div className='text-center border border-dashed border-fieldOutline rounded-lg mt-4'><Link className='textLink text-center block bg-fieldBg rounded-8 p-3 my-0' onClick={showSection}>Add a section</Link></div>
                     <div className='text-center border border-dashed border-fieldOutline rounded-lg mt-4'><Link className='textLink text-center block bg-fieldBg rounded-8 p-3 my-0' onClick={openTaskModal}>Add a task</Link></div>
                  </div>
               </>
         ...
         <Footer />
         <CustomModal isOpen={modalIsOpen} isClose={closeTaskModal} component={<AddTask />} title="Add a task" />
      </div>
   )
}
