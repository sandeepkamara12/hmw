...
const Projects = () => {
   ...
   return (
      <div className={`sm:ml-20 py-7 sm:py-18`}>
         {
            hideHeader === 'show' && <div className='header sidebar'>
               <Link to="/" className='mb-10 sm:mb-14 sm:mt-7 mx-auto inline-block'>
         ...
         <div className="custom-medium-container">
            <div className={hideButton === 'hide' ? 'sticky-header border-b-fieldOutline' : 'relative px-4 sm:px-0'}>
               <div className={`flex flex-wrap items-center mb-8 sm:mb-12 ${hideButton === 'hide' ? 'justify-center mb-6' : 'justify-between'}`}>
                  <h1 className={`headingOne !text-left !mb-0 ${hideButton === 'hide' ? '!text-18 !leading-21' : ''}`}>Projects</h1>
                  {
                     hideButton === 'show' && <div>
                        <Button classes='custom-button custom-button-small custom-button-outline-primary' attributes={{ type: 'button', disabled: false, value: "Add project", clickEvent: handleClick }}></Button>
                     </div>
                  }
               </div>
               <div className="tabs">
                  <Button attributes={{ type: 'button', disabled: false, value: "active", clickEvent: handleClick }} classes="tab active" />
                  <Button attributes={{ type: 'button', disabled: false, value: "upcoming", clickEvent: handleClick }} classes="tab" />
                  <Button attributes={{ type: 'button', disabled: false, value: "complete", clickEvent: handleClick }} classes="tab" />
               </div>
            </div>
            <div className="px-4 sm:px-0">
               <div className='tab-panel'>
                  <div className={`text-16 leading-20 my-4 font-semibold font-inter-regular text-black ${width <= 640 && 'mt-8'}`}>Q3 2022<span className='text-14 leading-18 font-normal ml-2 inline-block text-gray'>(Nov 1 - Jan 31)</span></div>
                  <div className='project-listing'>
                     ...
                     <Link to="/" className='project-wrap'>
                        <span className='project-content-wrap block'>
                           ...
                           <span className='track-label font-mono-regular text-black border border-fieldOutline rounded-full py-5 pr-3 pl-8 text-10 relative inline-block'>
                              <span className='project-status w-2.5 h-2.5 rounded-full bg-status inline-block absolute left-3 top-1.5'></span>
                              On-track: Oct 12-14
                           </span>
                        </span>
                     ...
                     <Link className='textLink text-center block bg-fieldBg rounded-8 p-3' to="/">1 completed project</Link>
